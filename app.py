...
st.write("")
team = ["ANGGOTA<br/>TIM<br/>SATU", "ANGGOTA<br/>TIM<br/>DUA", "ANGGOTA<br/>TIM<br/>TIGA", "DIAR<br/>ALYA<br/>ADRIANA"]
roles = ["ENGINEER", "ENGINEER", "ENGINEER", "ENGINEER"]
cols = st.columns(4)
for c, name, role in zip(cols, team, roles):
    with c:
        st.markdown(
            f'<div class="pf-team-card"><div class="pf-team-name">{name}</div>'
