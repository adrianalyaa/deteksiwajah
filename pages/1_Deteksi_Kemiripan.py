...
with col_result:
    ...
    st.markdown('<span class="pf-label-light">HASIL ANALISIS</span>', unsafe_allow_html=True)
    ...
    st.markdown(
        ...
        f'color:var(--pink-light);text-align:center;margin-bottom:14px;">{label_text}</div>',
        unsafe_allow_html=True,
    )
