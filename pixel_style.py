...
.pf-team-card {
    border: 3px solid var(--pink-dark);
    background: var(--pixel-black);
    box-shadow: 4px 4px 0 var(--pink-deeper);
...
/* ===== TEAM FOTO ===== */
.pf-team-card img,
.pf-team-card [data-testid="stImage"] img {
    border: 3px solid var(--pink-dark) !important;
    box-shadow: 3px 3px 0 var(--pink-deeper) !important;
    aspect-ratio: 1/1;
    object-fit: cover;
}
